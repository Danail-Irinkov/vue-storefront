...
<!--          <span v-else-if="getSelectedShippingMethods[brandId].name === method.name && getSelectedShippingMethods[brandId].cost > 0">{{ getSelectedShippingMethods[brandId].cost | price }}</span>-->
