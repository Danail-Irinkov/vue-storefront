    ...
    >
      <thead>
        <tr>
          ...
          <th scope="col" class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][0]">
            {{ $t(columnsPerType[size_chart.type][0]) }}
          </th>
          <th scope="col" class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][1]">
            {{ $t(columnsPerType[size_chart.type][1]) }}
          </th>
          <th scope="col" class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][2]">
            {{ $t(columnsPerType[size_chart.type][2]) }}
          </th>
          <th scope="col" class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][3]">
            {{ $t(columnsPerType[size_chart.type][3]) }}
          </th>
        </tr>
      </thead>
      <tbody>
        <tr v-for="(size, index) in size_chart.columns" :key="index">
          <th v-if="product_data && product_data.stock_qty && Object.keys(product_data.stock_qty).length > 0"
          ...
          <td class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][0]">
            {{ size.bust }} cm
          </td>
          <td class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][1]">
            {{ size.waist }} cm
          </td>
          <td class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][2]">
            {{ size.hip }} cm
          </td>
          <td class="text-align-center" v-if="columnsPerType[size_chart.type] && columnsPerType[size_chart.type][3]">
            {{ size.length }} cm
          </td>
        </tr>
      </tbody>
...
export default {
  ...
  created () {
    ...
    if (this.size_chart) { this.setSizeChartMobileLabels(this.size_chart.type) }
  },
  computed: {
  },
  methods: {
