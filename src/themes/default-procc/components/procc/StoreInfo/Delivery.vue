  ...
  <div class="row">
    <div class="col-md-12">
      <form method="#" action="#" @submit.prevent style="padding-left: 2rem;">
        ...
        <div class="row" style="padding-left: 0.6rem"
...
export default {
  ...
  mounted () {
    console.log('StoreDelivery MOUNTED!')
  },
  methods: {
  ...
  computed: {
    ...
    policy_data () {
      return this.currentStore && this.currentStore.storefront_setting && this.currentStore.storefront_setting.shipping_policy ? this.currentStore.storefront_setting.shipping_policy : this.currentStoreView.shipping_policy ? this.currentStoreView.shipping_policy : {}
    },
    currentStoreView () {
